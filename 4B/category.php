...
<body>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title"><strong><span id="md_func"></span></strong> Category</h5>
				</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			var html = '<tr><td colspan="3"><a role="button" class="btn btn-outline-success btn-add mt-2">Add Category</a></td></tr>'
			...
			function writer_get() {
				...
				$.ajax({
					...
					success 	: function(data){
						...
						html += '<tr><td colspan="3"><a role="button" class="btn btn-outline-success btn-add mt-2">Add Category</a></td></tr>'
						$('#table_content').html(html);
					}
				});
			}
			...
			$('.btn-submitt').click(function() {
				...
				switch(funcname) {
					case "Add":
						data 	= {function:'category_insert', name:name};
						break;
					case "Update":
						id 		= $(this).data('id');
						data 	= {function:'category_update', id:id, name:name};
						break;
					case "Delete":
						id 		= $(this).data('id');
						data 	= {function:'category_delete', id:id};
						break;
				}
				$.ajax({
					type 		: 'POST',
